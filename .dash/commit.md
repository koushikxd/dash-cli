...
Use conventional commits: `type: description` or `type(cli): description` or `type(web): description`


## Style Rules

- **Tense**: Imperative/present ("allow", "generate", "use", "add", "remove", "merge", "fix", "update")

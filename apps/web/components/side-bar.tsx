...
export function Sidebar() {
  ...
  return (
    <div className="fixed start-0 top-0">
      <aside className="bg-background absolute top-16 hidden h-[calc(100vh-4rem)] shrink-0 flex-col border-r md:flex md:w-[268px] md:transition-all lg:w-[286px]">
        <div className="flex h-full flex-col justify-between overflow-y-auto pb-2">
          <MotionConfig
